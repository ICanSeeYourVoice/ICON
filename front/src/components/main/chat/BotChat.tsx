...
const BotChat: React.FC<{ text: string; timestamp: Date }> = ({
  ...
  return (
    <div className="flex justify-start w-[18rem] mb-[1rem]">
      <div className="min-h-[3.5rem] max-w-[11rem] bg-gray-500 rounded-tr-[1rem] rounded-bl-[1rem] rounded-br-[1rem] p-3 flex items-center">
        <div className="text-white text-[0.8rem] font-normal break-words overflow-hidden">
          {text}
        </div>
      </div>
      <div className="text-black text-[0.6rem] mt-1 self-end ml-2">
